...
Mirrors the behavior of scripts/bash/update-agent-context.sh:
 ...
 5. Multi-Agent Support (claude, gemini, copilot, cursor, qwen, opencode, codex, windsurf, kilocode, auggie, roo, droid)
...
$DROID_FILE    = Join-Path $REPO_ROOT '.droid/rules/specify-rules.md'
